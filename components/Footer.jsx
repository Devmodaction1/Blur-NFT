    ...
    <footer className="flexCenter flex-col border-t dark:border-nft-black-1 border-nft-gray-1 sm:py-8 py-16">
      <div className="w-full minmd:w-4/5 flex flex-row md:flex-col sm:px-4 px-16">
        <div className="flexStart flex-1 flex-col">
          <div className="flexCenter cursor-pointer">
            <Image src={blur} objectFit="contain" width={32} height={32} alt="logo" />
            <p className=" dark:text-white text-nft-dark font-semibold text-lg ml-1">NFT Market</p>
          </div>
      ...
      <div className="flexCenter w-full mt-5 border-t dark:border-nft-black-1 border-nft-gray-1 sm:px-4 px-16">
        <div className="flexBetween flex-row w-full minmd:w-4/5 sm:flex-col mt-7">
          <p className="font-poppins dark:text-white text-nft-black-1 font-semibold text-base">© 2023 NFT Market. All Rights Reserved.</p>
          <div className="flex flex-row sm:mt-4">
            <a href="https://github.com/querylab" target="_blank" rel="noopener noreferrer"> <Image src={images.instagram} alt="social" width={40} height={40} className={theme === 'light' ? 'filter invert' : undefined} /> </a>
            <a href="https://twitter.com/querylab" target="_blank" rel="noopener noreferrer"><Image src={images.twitter} alt="social" width={40} height={40} className={theme === 'light' ? 'filter invert' : undefined} /> </a>
            <a href="https://medium.com/@querylab" target="_blank" rel="noopener noreferrer"> <Image src={images.discord} alt="social" width={40} height={40} className={theme === 'light' ? 'filter invert' : undefined} /> </a>
          </div>
        </div>
      </div>
    </footer>
