  ...
  return (
    <div className="relative flex justify-center md:flex-col min-h-screen">
      ...
      <div className="flex-1 justify-start sm:px-4 p-12 sm:pb-4">
        ...
        <div className="mt-10">
          <p className="font-poppins dark:text-white text-nft-black-1 text-xs minlg:text-base font-normal">Trainer Creator</p>
        ...
        <div className="mt-10 flex flex-col">
          <div className="w-full border-b dark:border-nft-black 1 border-nft-gray-1 flex flex-row">
            <p className="font-poppins dark:text-white text-nft-black-1 text-base font-medium mb-2">Details of NFTs</p>
          </div>
          <div className="mt-3">
