...
const PaymentBodyCmp = ({ nft, nftCurrency }) => (
  <div className="flex flex-col">
    <div className="flexBetween">
      <p className="font-poppins dark:text-white text-nft-black-1 font-semibold text-base minlg:text-lg">
        Item
      </p>
      <p className="font-poppins dark:text-white text-nft-black-1 font-semibold text-base minlg:text-lg">
        Subtotal
    ...
    <div className="flexBetween mt-10">
      <p className="font-poppins dark:text-white text-nft-black-1 text-base minlg:text-xl">
        Total
      </p>
      <p className="font-poppins dark:text-white text-nft-black-1 text-sm minlg:text-xl">
        {nft.price} <span className="font-semibold">{nftCurrency}</span>
...
const NFTDetails = () => {
  ...
  return (
    <div className="relative flex justify-center md:flex-col min-h-screen">
      <Head>
        <title>{nft.name} Market NFTs</title>
      ...
      <div className="flex-1 justify-start sm:px-4 p-12 sm:pb-4">
        ...
        <div className="flex flex-row sm:flex-col mt-10">
          {currentAccount.toLowerCase() === nft.seller.toLowerCase() ? (
            <p className="font-poppins dark:text-white text-nft-black-1 text-base font-normal border border-gray rounded-lg p-2">
